...
- Secure login using cookie authentication
- Password hashing with BCrypt
- User profile management
- Account settings and preferences

### Trip Management
- Browse available trips with filtering
- Advanced search functionality
- Trip details with images, dates, and ratings
- Trip creation and editing (Admin)
- Image upload support

### Booking System
- Shopping cart functionality with expiration
- Multiple trip selections per booking
...
- Automatic waitlist expiration (configurable)
...
### Real-time Updates
- SignalR for live trip availability
...
#### TripDates
- TripDateId (Primary Key)
- TripId (Foreign Key)
- AvailableDate
- SpotsAvailable

#### UserTrips
- UserTripId (Primary Key)
- UserId (Foreign Key)
- TripId (Foreign Key)
- BookingDate
- Quantity
...
- Users have many Trips (bookings)
- Trips have many Users (bookings)
- Trips have many TripDates
- Trips have many TripImages
- Trips have many TripRatings
- Users have many WaitlistEntries
- Trips have many WaitlistEntries
- Users have many Feedback entries
